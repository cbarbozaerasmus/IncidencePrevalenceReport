...
knitr::kable(prevalenceData, caption = 'A caption')
```

Here is a table showing the results for prevalence for the years **`r prevalenceData$time`**. The prevalence values are **`r prevalenceData$prev`** respectively. 
